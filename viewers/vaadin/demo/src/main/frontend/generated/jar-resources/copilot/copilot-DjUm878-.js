...
}, qo = process.env.NODE_ENV !== "production" ? Ho : {};
function p(e) {
  for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), r = 1; r < t; r++)
    n[r - 1] = arguments[r];
  if (process.env.NODE_ENV !== "production") {
    var i = typeof e == "string" ? e : qo[e];
...
var Gn = {};
Object.freeze(Gn);
var Wo = typeof Proxy < "u", Go = /* @__PURE__ */ Object.toString();
function vi() {
  Wo || p(process.env.NODE_ENV !== "production" ? "`Proxy` objects are not available in the current environment. Please configure MobX to enable a fallback implementation.`" : "Proxy not available");
}
function rt(e) {
...
function P(e) {
  ...
  return typeof n == "function" && n.toString() === Go;
}
function hi(e) {
  var t = e?.constructor;
...
var Xo = Object.getOwnPropertyDescriptors || function(t) {
  var n = {};
...
function yi(e, t, n) {
  ...
  var r = new ge(e);
  return t !== ze && fs(r, t), n !== ze && qi(r, n), r;
}
function ra(e, t) {
  return ro(e, t);
}
...
function wi(e, t, n, r, i) {
  var o, a, s, l, c, u, d;
  i === void 0 && (i = f.safeDescriptors), da(e, t, n, r);
  var v = r.value;
...
function Ai(e, t, n, r, i, o) {
  o === void 0 && (o = f.safeDescriptors), ha(e, t, n, r);
  var a = r.value;
  if (_t(a) || (a = qe(a)), i) {
    var s;
...
function ma(e, t, n, r) {
  return _a(e, this, t, n), e.defineComputedProperty_(t, ve({}, this.options_, {
    get: n.get,
    set: n.set
  }), r);
}
...
function wa(e, t, n, r) {
  var i, o;
  return Aa(e, this, t, n), e.defineObservableProperty_(t, n.value, (i = (o = this.options_) == null ? void 0 : o.enhancer) != null ? i : Ne, r);
}
function Ea(e, t) {
  if (process.env.NODE_ENV !== "production") {
    if (t.kind === "field")
...
var Pa = "observable", $a = "observable.ref", Da = "observable.shallow", ka = "observable.struct", xi = {
  deep: !0,
  name: void 0,
...
var Tn = /* @__PURE__ */ cn(Pa), Ta = /* @__PURE__ */ cn($a, {
  enhancer: ln
}), Ia = /* @__PURE__ */ cn(Da, {
  enhancer: oa
}), Va = /* @__PURE__ */ cn(ka, {
...
function Dt(e) {
  return e.deep === !0 ? Ne : e.deep === !1 ? ln : ja(e.defaultDecorator);
}
function Ra(e) {
  var t;
  return e ? (t = e.defaultDecorator) != null ? t : Oi(e) : void 0;
}
function ja(e) {
  var t, n;
...
var Ma = {
  ...
  array: function(t, n) {
    var r = $t(n);
    return (f.useProxies === !1 || r.proxy === !1 ? Is : Os)(t, Dt(r), r.name);
  },
  map: function(t, n) {
    var r = $t(n);
  ...
  object: function(t, n, r) {
    return Ie(function() {
      return Wi(f.useProxies === !1 || r?.proxy === !1 ? Ze({}, r) : ws({}, r), t, n);
    });
  },
  ref: /* @__PURE__ */ Q(Ta),
  shallow: /* @__PURE__ */ Q(Ia),
  deep: Si,
  struct: /* @__PURE__ */ Q(Va)
}, x = /* @__PURE__ */ pi(Ni, Ma), Ci = "computed", La = "computed.struct", In = /* @__PURE__ */ Xn(Ci), za = /* @__PURE__ */ Xn(La, {
...
Object.assign(un, In);
un.struct = /* @__PURE__ */ Q(za);
var vr, hr, qt = 0, Ua = 1, Ba = (vr = (hr = /* @__PURE__ */ Bt(function() {
...
var Ka = "create", xe = /* @__PURE__ */ function(e) {
  ...
  return t.onBecomeStale_ = function() {
    ...
    this.observers_.size === 0 && !this.keepAlive_)
      ...
      this.keepAlive_ && !r && (f.trackingContext = this), this.trackAndCompute() && Xa(this), f.trackingContext = r;
    }
    var i = this.value_;
    if (Mt(i))
      throw i.cause;
...
function $i(e, t, n) {
  ...
  return f.inBatch--, f.trackingDerivation = i, Ya(e), Ga(e), pt(r), o;
}
function Ga(e) {
...
function ji(e, t) {
  if (console.log("[mobx.trace] '" + e.name_ + "' is invalidated due to a change in: '" + t.name_ + "'"), e.isTracing_ === U.BREAK) {
    var n = [];
    Mi(ps(e), n, 1), new Function(`debugger;
/*
Tracing '` + e.name_ + `'
...
var mr = 100, es = function(t) {
  return t();
};
function Li() {
  f.inBatch > 0 || f.isRunningReactions || es(ts);
}
function ts() {
...
var Qn = "action", is = "action.bound", zi = "autoAction", os = "autoAction.bound", Ui = "<unnamed action>", jn = /* @__PURE__ */ Nt(Qn), as = /* @__PURE__ */ Nt(is, {
  bound: !0
}), Mn = /* @__PURE__ */ Nt(zi, {
  autoAction: !0
}), ss = /* @__PURE__ */ Nt(os, {
...
var Ae = /* @__PURE__ */ Bi(!1);
Object.assign(Ae, jn);
var bt = /* @__PURE__ */ Bi(!0);
Object.assign(bt, Mn);
Ae.bound = /* @__PURE__ */ Q(as);
bt.bound = /* @__PURE__ */ Q(ss);
function Au(e) {
...
function er(e, t, n) {
  ...
  var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + F() : "Reaction", s = Ae(a, n.onError ? cs(n.onError, t) : t), l = !n.scheduler && !n.delay, c = Hi(n), u = !0, d = !1, v, h = n.compareStructural ? Fe.structural : n.equals || Fe.default, b = new te(a, function() {
    u || l ? E() : d || (d = !0, c(E));
...
function Gi(e) {
  ...
  return e.observing_ && e.observing_.length > 0 && (t.dependencies = vs(e.observing_).map(Gi)), t;
}
function vs(e) {
...
var wn = /* @__PURE__ */ Ei("flow"), gs = /* @__PURE__ */ Ei("flow.bound", {
  bound: !0
  ...
  var r = t, i = r.name || "<unnamed flow>", o = function() {
    var s = this, l = arguments, c = ++hs, u = Ae(i + " - runid: " + c + " - init", r).apply(s, l), d, v = void 0, h = new Promise(function(b, E) {
      var S = 0;
      d = E;
      function Y($) {
        v = void 0;
...
function yt(e) {
  return process.env.NODE_ENV !== "production" && arguments.length !== 1 && p("isObservable expects only 1 argument. Use isObservableProp to inspect the observability of a property"), ms(e);
}
function bs() {
  if (process.env.NODE_ENV !== "production") {
...
function ws(e, t) {
  var n, r;
  return vi(), e = Ze(e, t), (r = (n = e[m]).proxy_) != null ? r : n.proxy_ = new Proxy(e, ys);
}
function j(e) {
...
var _r = "splice", H = "update", Es = 1e4, As = {
  get: function(t, n) {
    var r = t[m];
...
var xs = /* @__PURE__ */ ke("ObservableArrayAdministration", tr);
function vn(e) {
  return on(e) && xs(e[m]);
}
var Ss = {}, fe = "add", Yt = "delete", Xi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = Ne), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + F() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[m] = Ss, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = r, this.name_ = i, O(Map) || p(18), Ie(function() {
  ...
  return t.has_ = function(r) {
    ...
    return me(r) && (r = new Map(r)), ae(function() {
      P(r) ? Jo(r).forEach(function(o) {
        ...
        var a = o[0], s = o[1];
        return i.set(a, s);
      }) : Ye(r) ? (Yo(r) || p(19, r), r.forEach(function(o, a) {
        return i.set(a, o);
      })) : r != null && p(20, r);
    }), this;
  }, t.clear = function() {
    ...
    var i = this;
    return ae(function() {
      for (var o = Ns(r), a = /* @__PURE__ */ new Map(), s = !1, l = Ue(i.data_.keys()), c; !(c = l()).done; ) {
        var u = c.value;
        if (!o.has(u)) {
          var d = i.delete(u);
          if (d)
...
var Cs = {}, Zi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = Ne), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + F() : "ObservableSet"), this.name_ = void 0, this[m] = Cs, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, O(Set) || p(22), this.enhancer_ = function(a, s) {
      return r(a, s, i);
    }, Ie(function() {
...
Extending builtins is not supported.`), e;
  ...
  var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (P(e) ? "ObservableObject" : e.constructor.name) + "@" + F() : "ObservableObject", i = new Ln(e, /* @__PURE__ */ new Map(), String(r), Ra(t));
  return an(e, m, i), e;
}
var Ps = /* @__PURE__ */ ke("ObservableObjectAdministration", Ln);
function Or(e) {
  return Er[e] || (Er[e] = {
    get: function() {
...
var $s = /* @__PURE__ */ eo(0), Ds = /* @__PURE__ */ function() {
  var e = !1, t = {};
...
var nr = /* @__PURE__ */ function(e) {
  function t(r, i, o, a) {
    ...
    return o === void 0 && (o = process.env.NODE_ENV !== "production" ? "ObservableArray@" + F() : "ObservableArray"), a === void 0 && (a = !1), s = e.call(this) || this, Ie(function() {
      ...
      l.proxy_ = s, gi(s, m, l), r && r.length && s.spliceWithArray(0, 0, r), Ds && Object.defineProperty(s, "0", $s);
    }), s;
  }
  _i(t, e);
  var n = t.prototype;
...
var Pr, Vs = ((Pr = Wn().Iterator) == null ? void 0 : Pr.prototype) || {};
function rr(e) {
  return e[Symbol.iterator] = Rs, Object.assign(Object.create(Vs), e);
}
function Rs() {
  return this;
}
...
const js = Symbol.for("react.portal"), Ms = Symbol.for("react.fragment"), Ls = Symbol.for("react.strict_mode"), zs = Symbol.for("react.profiler"), Us = Symbol.for("react.provider"), Bs = Symbol.for("react.context"), oo = Symbol.for("react.forward_ref"), Fs = Symbol.for("react.suspense"), Hs = Symbol.for("react.suspense_list"), qs = Symbol.for("react.memo"), Ks = Symbol.for("react.lazy");
function Ws(e, t, n) {
...
function Ou() {
  ...
  return Array.from(document.body.querySelectorAll("*")).flatMap(Js).filter(Gs).filter((n) => !n.fileName.includes("frontend/generated/")).forEach((n) => e.add(n.fileName)), Array.from(e);
}
function Gs(e) {
  return !!e && e.fileName;
}
...
function rl(e) {
  return typeof e.type != "function" || so(e) ? !1 : !!(Zt(e) || Ys(e));
}
function so(e) {
  if (!e)
    return !1;
...
const hn = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), Re = "copilot-", il = "24.8.5", ol = "undefined", xu = "attention-required", Su = "https://plugins.jetbrains.com/plugin/23758-vaadin", Nu = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Cu(e) {
...
function gn(e) {
  Promise.resolve().then(() => gc).then(({ showNotification: t }) => {
    t(e);
  });
}
function dl() {
...
function fl(e) {
  return e.children && (e.children = e.children.filter(fl)), e.visible !== !1;
}
async function uo() {
  return co(() => {
...
const hl = (e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom, ir = (e) => {
  const t = [];
  let n = ml(e);
  for (; n; )
...
function bl(e) {
  return e instanceof Element && typeof e.getBoundingClientRect == "function" ? e.getBoundingClientRect() : _l(e);
}
function _l(e) {
...
function Al(e, t) {
  const n = wl(e), r = n.getBoundingClientRect();
...
function Ru(e) {
  const t = fo(e), n = gl(t);
  !t.every((i) => El(i, n)) && t.length > 0 && t[0].scrollIntoView();
}
function fo(e) {
  const t = e;
  if (!t)
...
function xl(e) {
  ...
  !hl(document.documentElement.getBoundingClientRect(), t, n);
}
function Rr(e) {
  const t = bl(e);
...
class Cl {
  ...
  addRecentSwitchedUsername(t) {
    this.setRecentSwitchedUsernames(ul([t, ...this.recentSwitchedUsernames]));
  }
...
window.Vaadin.copilot._uiState = new vl();
window.Vaadin.copilot.eventbus = new Fo();
window.Vaadin.copilot.overlayManager = new Nl();
window.Vaadin.copilot._machineState = new Cl();
window.Vaadin.copilot._storedProjectState = new kl();
window.Vaadin.copilot._previewState = new Pl();
window.Vaadin.copilot._sectionPanelUiState = new $l();
window.Vaadin.copilot._earlyProjectState = new Dl();
/**
 * @license
...
const R = (e) => new bo(typeof e == "string" ? e : e + "", void 0, ar), Il = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Rl, defineProperty: jl, getOwnPropertyDescriptor: Ml, getOwnPropertyNames: Ll, getOwnPropertySymbols: zl, getPrototypeOf: Ul } = Object, mn = globalThis, Br = mn.trustedTypes, Bl = Br ? Br.emptyScript : "", Fl = mn.reactiveElementPolyfillSupport, vt = (e, t) => e, Fn = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Bl : null;
      break;
  ...
  return n;
} }, _o = (e, t) => !Rl(e, t), Fr = { attribute: !0, type: String, converter: Fn, reflect: !1, useDefault: !1, hasChanged: _o };
...
let Le = class extends HTMLElement {
  ...
  static createProperty(t, n = Fr) {
    if (n.state && (n.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t) && ((n = Object.create(n)).wrapped = !0), this.elementProperties.set(t, n), !n.noAccessor) {
      ...
      i !== void 0 && jl(this.prototype, t, i);
    }
  }
  static getPropertyDescriptor(t, n, r) {
    const { get: i, set: o } = Ml(this.prototype, t) ?? { get() {
      return this[n];
    }, set(a) {
      this[n] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(vt("properties"))) {
      const n = this.properties, r = [...Ll(n), ...zl(n)];
  ...
  createRenderRoot() {
    ...
    return Vl(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
...
Le.elementStyles = [], Le.shadowRootOptions = { mode: "open" }, Le[vt("elementProperties")] = /* @__PURE__ */ new Map(), Le[vt("finalized")] = /* @__PURE__ */ new Map(), Fl?.({ ReactiveElement: Le }), (mn.reactiveElementVersions ??= []).push("2.1.0");
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const sr = globalThis, nn = sr.trustedTypes, qr = nn ? nn.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, yo = "$lit$", de = `lit$${Math.random().toFixed(9).slice(2)}$`, wo = "?" + de, Kl = `<${wo}>`, De = document, Et = () => De.createComment(""), At = (e) => e === null || typeof e != "object" && typeof e != "function", lr = Array.isArray, Wl = (e) => lr(e) || typeof e?.[Symbol.iterator] == "function", Sn = `[ 	
\f\r]`, ot = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Kr = /-->/g, Wr = />/g, ye = RegExp(`>|${Sn}(?:([^\\s"'>=/]+)(${Sn}*=${Sn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Gr = /'/g, Yr = /"/g, Eo = /^(?:script|style|textarea|title)$/i, Ao = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), ee = Ao(1), zu = Ao(2), he = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), Jr = /* @__PURE__ */ new WeakMap(), Oe = De.createTreeWalker(De, 129);
function Oo(e, t) {
...
const Gl = (e, t) => {
  ...
  for (let s = 0; s < n; s++) {
    ...
    o += a === ot ? l + Kl : d >= 0 ? (r.push(c), l.slice(0, d) + yo + l.slice(d) + de + h) : l + de + (d === -2 ? s : h);
  }
...
class Ot {
  constructor({ strings: t, _$litType$: n }, r) {
    ...
    this.parts = [];
    let o = 0, a = 0;
    const s = t.length - 1, l = this.parts, [c, u] = Gl(t, n);
    ...
    for (; (i = Oe.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(yo)) {
          ...
          l.push({ type: 1, index: o, name: b[2], strings: h, ctor: b[1] === "." ? Jl : b[1] === "?" ? Xl : b[1] === "@" ? Zl : bn }), i.removeAttribute(d);
...
let Yl = class {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new et(o, o.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(o, l.name, l.strings, this, t) : l.type === 6 && (c = new Ql(o, this, t)), this._$AV.push(c), l = r[++s];
      }
...
class et {
  ...
  _$AI(t, n = this) {
    t = Ge(this, t, n), At(t) ? t === A || t == null || t === "" ? (this._$AH !== A && this._$AR(), this._$AH = A) : t !== this._$AH && t !== he && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Wl(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: n, _$litType$: r } = t, i = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = Ot.createElement(Oo(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === i) this._$AH.p(n);
    else {
      const o = new Yl(i, this), a = o.u(this.options);
...
const ec = { I: et }, tc = sr.litHtmlPolyfillSupport;
tc?.(Ot, et), (sr.litHtmlVersions ??= []).push("3.3.0");
const nc = (e, t, n) => {
...
let ht = class extends Le {
  ...
  update(t) {
    const n = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = nc(n, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const rc = cr.litElementPolyfillSupport;
rc?.({ LitElement: ht });
(cr.litElementVersions ??= []).push("4.2.0");
class ic extends ql(ht) {
}
class oc extends ic {
  constructor() {
...
function ac() {
  Ee.push(import("./copilot-log-plugin-BpggpXch.js")), Ee.push(import("./copilot-info-plugin-B0GKKxEN.js")), Ee.push(import("./copilot-features-plugin-CQNfEn1I.js")), Ee.push(import("./copilot-feedback-plugin-Brtnc2RB.js")), Ee.push(import("./copilot-shortcuts-plugin-OFqZooD-.js"));
}
function sc() {
  {
    const e = `https://cdn.vaadin.com/copilot/${il}/copilot-plugins${ol}.js`;
    import(
      /* @vite-ignore */
      e
    ).catch((t) => {
...
const Vt = new cc(), y = window.Vaadin.copilot.eventbus;
if (!y)
  throw new Error("Tried to access copilot eventbus before it was initialized.");
const st = window.Vaadin.copilot.overlayManager, Hu = {
...
class Hn extends No {
  constructor(t) {
    if (super(t), this.it = A, t.type !== xo.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
const uc = So(Hn), tt = window.Vaadin.copilot._machineState;
if (!tt)
  throw new Error("Trying to use stored machine state before it was initialized");
const dc = 5e3;
let Qr = 1;
function Co(e) {
  g.notifications.includes(e) && (e.dontShowAgain && e.dismissId && fc(e.dismissId), g.removeNotification(e), y.emit("notification-dismissed", e));
}
function Po(e) {
...
function ur() {
  return dr() ? ee`<vaadin-button
      ...
      @click=${(e) => {
    const t = e.target;
    t.disabled = !0, t.innerText = "Restarting...", mc();
  }}>
      Restart now
    </vaadin-button>` : A;
}
...
function hc(e) {
  ...
  return g.setNotifications([...g.notifications, n]), (e.delay || !e.link && !e.dismissId) && setTimeout(() => {
    Co(n);
  }, e.delay ?? dc), y.emit("notification-shown", e), n;
}
const gc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  dismissNotification: Co,
  getRestartRequiredMessage: vc,
...
const bc = async () => co(() => g.userInfo), qu = async () => (await bc()).vaadiner;
function _c() {
  const e = g.userInfo;
...
const yc = (e) => {
...
}, wc = (e, t) => e.error ? (Ec(e.error, t), !0) : !1, ei = (e, t, n) => {
  gn({
    type: Ve.ERROR,
    message: e,
    details: tn(
      ee`<vaadin-details summary="Details" style="color: var(--dev-tools-text-color)"
          ><div>
            <code class="codeblock"><copilot-copy></copilot-copy>${uc(t)}</code>
          </div>
        </vaadin-details>
        ${n !== void 0 ? ee`
              <vaadin-button
  ...
  i && o ? Oc(
    ...
    t,
    n
  ) : ei(e, t), _c() && y.emit("system-info-with-callback", {
  ...
  window.Vaadin.ConsoleErrors = {
    push: (n) => {
      n[0].type !== void 0 && n[0].message !== void 0 ? e({
        ...
        details: n[0].details,
        link: n[0].link
      }) : e({ type: Ve.ERROR, message: n.map((r) => xc(r)).join(" "), internal: !1 }), t.push(n);
    }
  };
}
function xc(e) {
...
const Nc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  handleErrorDuringOperation: yc,
  handleServerOperationErrorIfNeeded: wc,
  installErrorHandlers: To,
  showNotReactFlowProject: Sc
}, Symbol.toStringTag, { value: "Module" })), Vo = () => {
  Cc().then((e) => g.setUserInfo(e)).catch((e) => ce("Failed to load userInfo", e));
}, Cc = async () => hn(`${Re}get-user-info`, {}, (e) => (delete e.data.reqId, e.data));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ro = Symbol.for(""), Pc = (e) => {
  if (e?.r === Ro) return e?._$litStatic$;
}, jo = (e) => ({ _$litStatic$: e, r: Ro }), ni = /* @__PURE__ */ new Map(), $c = (e) => (t, ...n) => {
  const r = n.length;
  let i, o;
  const a = [], s = [];
  let l, c = 0, u = !1;
...
const { I: Dc } = ec, Ku = (e) => e.strings === void 0, ri = () => document.createComment(""), lt = (e, t, n) => {
  ...
  return n;
}, we = (e, t, n = e) => (e._$AI(t, n), e), kc = {}, Tc = (e, t = kc) => e._$AH = t, Ic = (e) => e._$AH, Cn = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const ii = (e, t, n) => {
  ...
  update(e, [t, n, r]) {
    const i = Ic(e), { values: o, keys: a } = this.dt(t, n, r);
    ...
    return this.ut = a, Tc(e, l), he;
  }
}), zt = /* @__PURE__ */ new Map(), Vc = (e) => {
...
const zc = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), oi = { randomUUID: zc };
function Lo(e, t, n) {
  if (oi.randomUUID && !e)
    return oi.randomUUID();
  e = e || {};
  const r = e.random ?? e.rng?.() ?? Lc();
  if (r.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, jc(r);
}
const Ut = [], ft = [], Yu = async (e, t, n) => {
  let r, i;
  t.reqId = Lo();
...
const si = new iu(), ou = "copilot-development-setup-user-guide";
function Zu() {
  wt("use-dev-workflow-guide"), le.updatePanel(ou, { floating: !0 });
}
function Bo() {
  const e = g.jdkInfo;
...
class lu {
  ...
  includeReactNode(t) {
    return dt(t) === "PreconfiguredAuthProvider" || dt(t) === "RouterProvider" ? !1 : kr(t) || rl(t);
  }
  async includeFlowNode(t) {
    return ll(t) || On(t)?.hiddenByServer ? !1 : this.isInitializedInProjectSources(t);
  }
  ...
  async addToTree(t, n) {
    ...
    const a = o ?? n, s = i ? Array.from(t.children) : el(t);
    for (const l of s)
  ...
  generateNodeFromFlow(t, n) {
    ...
    return {
      ...
      get name() {
        return al(r) ?? Ir(r.element.localName);
      },
      get identifier() {
        return Vr(t);
      },
...
const di = (e) => {
  ...
  if (ui(e))
    ...
    if (g.loginCheckActive ? g.setLoginCheckActive(!1) : y.emit("close-drawers", {}), gu(t)) {
      e.stopPropagation();
      return;
    }
    if (mu(t))
      return;
  } else hu(e) ? (y.emit("delete-selected", {}), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "d" ? (y.emit("duplicate-selected", {}), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "b" ? (y.emit("show-selected-in-ide", { attach: e.shiftKey }), o = !0) : (e.ctrlKey || e.metaKey) && e.key === "z" && vu() ? (y.emit("undoRedo", { undo: !e.shiftKey }), o = !0) : ui(e) || y.emit("keyboard-event", { event: e });
  i && e.stopPropagation(), o && e.preventDefault();
}, hu = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey;
function gu(e) {
  const t = e;
  if (jr(e))
    return !0;
...
var bu = Object.getOwnPropertyDescriptor, _u = (e, t, n, r) => {
  for (var i = r > 1 ? void 0 : r ? bu(t, n) : t, o = e.length - 1, a; o >= 0; o--)
    (a = e[o]) && (i = a(i) || i);
  return i;
};
let fi = class extends oc {
  constructor() {
    ...
    }, this.operationInProgressCursorUpdateDebounceFunc = ru(this.toggleOperationInProgressAttr, 500), this.overlayOutsideClickListener = (e) => {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-B2Dmz1pA.js"), await import("./copilot-init-step2-DjwWb70y.js"), pl(), ac(), this.tabIndex = 0, Vt.hostConnectedCallback(), window.addEventListener("keydown", Kn), this.addEventListener("keydown", di), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
    ...
    t.observe(this), this.removers.push(() => {
      t.disconnect();
    }), To(), this.initialized = !0, su();
  }
  /**
   * Called when Copilot is activated. Good place to start attach listeners etc.
   */
  async activate() {
    Vt.activate(), si.copilotActivated(), lc(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), st.onCopilotActivation(), await cu(), Do.loadPreviewConfiguration(), this.active = !0, tt.isActivationAnimation() && g.activatedFrom !== "restore" && this.getAllDrawers().forEach((e) => {
  ...
  renderDrawer(e) {
    return ee` <copilot-drawer-panel position=${e}> ${Vc(e)} </copilot-drawer-panel>`;
  }
  /**
  ...
  updated(e) {
    super.updated(e), this.attachActivationButtonToBody(), Bc();
  }
